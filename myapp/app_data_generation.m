...
for key_idx = 1:length(grouping_keys)
    ...
    % Correct winner's curse values
    % FCP correction 0.95 - 0.05 - alpha hard coded
    corrected_power = ci_power_correction( ...
        power_by_method, ...
        grouped_data, ...
        method_level, ...
        ALL_METHODS ...
    ...
    for q_index = 1:numel(QUANTILES)
        ...
        % Use corrected for everything but 1 
        if quantile_percentage < 1
